...
// OR Building on/for an ARM architecture and using SSE2NEON.
    ...
    #define OCIO_USE_SSE2 1
    #define OCIO_USE_SSE3 1
    #define OCIO_USE_SSSE3 1
    #define OCIO_USE_SSE4 1
    #define OCIO_USE_SSE42 1
...
// Building for x86_64 processor on a non-ARM host architecture
    ...
    #define OCIO_USE_AVX 1
    #define OCIO_USE_AVX2 1
    #define OCIO_USE_AVX512 1
    #define OCIO_USE_F16C 1
