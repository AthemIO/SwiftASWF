...
template <class T> class HbrBilinearSubdivision : public HbrSubdivision<T> {
public:
  HbrBilinearSubdivision<T>() : HbrSubdivision<T>() {}
...
template <class T>
void HbrBilinearSubdivision<T>::transferFVarToChild(HbrMesh<T> *mesh,
                                                    HbrFace<T> *face,
                                                    HbrFace<T> *child,
                                                    int index) {
...
template <class T>
void HbrBilinearSubdivision<T>::transferEditsToChild(HbrFace<T> *face,
                                                     HbrFace<T> *child,
                                                     int index) {
...
template <class T>
void HbrBilinearSubdivision<T>::Refine(HbrMesh<T> *mesh, HbrFace<T> *face) {
...
template <class T>
HbrFace<T> *HbrBilinearSubdivision<T>::RefineFaceAtVertex(
    HbrMesh<T> *mesh, HbrFace<T> *face, HbrVertex<T> *vertex) {
...
template <class T>
void HbrBilinearSubdivision<T>::GuaranteeNeighbor(HbrMesh<T> *mesh,
                                                  HbrHalfedge<T> *edge) {
  if (edge->GetOpposite()) {
    return;
  }
...
template <class T>
void HbrBilinearSubdivision<T>::GuaranteeNeighbors(HbrMesh<T> *mesh,
                                                   HbrVertex<T> *vertex) {
...
template <class T>
bool HbrBilinearSubdivision<T>::HasLimit(HbrMesh<T> *mesh, HbrFace<T> *face) {
...
template <class T>
bool HbrBilinearSubdivision<T>::HasLimit(HbrMesh<T> * /* mesh */,
                                         HbrHalfedge<T> * /* edge */) {
  return true;
}
...
template <class T>
HbrVertex<T> *HbrBilinearSubdivision<T>::Subdivide(HbrMesh<T> *mesh,
                                                   HbrFace<T> *face) {
